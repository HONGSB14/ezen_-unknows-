...
<title>Insert title here</title>
	...
	<%@include file = "../footer.jsp" %>
					...
					<br>
					배송주소 : 
				<input type="text" name="maddress1" value="<%=member.getMaddress().split("_")[0] %>" id="sample4_postcode" name="address1" placeholder="우편번호">
				<input type="button"  onclick="sample4_execDaumPostcode()" value="우편번호 찾기"><br>
				<input type="text"  name="maddress2"  value="<%=member.getMaddress().split("_")[1] %>" id="sample4_roadAddress" name="address2" placeholder="도로명주소">
				<input type="text"  name="maddress3" value="<%=member.getMaddress().split("_")[2] %>" id="sample4_jibunAddress" name="address3" placeholder="지번주소">
				<span id="guide" style="color:#999;display:none"></span>
				<input type="text"  name="maddress4" value="<%=member.getMaddress().split("_")[3] %>" id="sample4_detailAddress" name="address4" placeholder="상세주소">
				<br>
					<input type="submit" value="변경적용">
					<a href="/jspweb/member/update.jsp"><button type="button">변경취소</button></a>
				</form>
